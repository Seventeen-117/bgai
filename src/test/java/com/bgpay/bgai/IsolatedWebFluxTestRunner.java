    ...
    excludeFilters = {
        ...
        @ComponentScan.Filter(
            ...
            classes = {
                ...
                WebFluxTestRunner.class,
                WebFluxOnlyTestRunner.class
            }
        )
    }
)
...
public class IsolatedWebFluxTestRunner {
    private static final Logger log = LoggerFactory.getLogger(IsolatedWebFluxTestRunner.class);
    
    public static void main(String[] args) {
        log.info("启动完全隔离的WebFlux测试运行器...");
        ...
        new SpringApplicationBuilder(IsolatedWebFluxTestRunner.class)
